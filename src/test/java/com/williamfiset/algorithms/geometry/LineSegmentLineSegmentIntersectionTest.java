...
public class LineSegmentLineSegmentIntersectionTest {
    ...
    static int[] bc = new int[20]; // Will contain number of branch hits for every branch
    ...
    public void testFromMain() {
        ...
        LineSegmentLineSegmentIntersection.Pt[] points = lineSegmentLineSegmentIntersection(p1, p2, p3, p4, bc);
